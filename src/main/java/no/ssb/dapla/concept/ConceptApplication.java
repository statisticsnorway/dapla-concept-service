...
public class ConceptApplication {
    ...
    static {
        ...
        LOG = LoggerFactory.getLogger(ConceptApplication.class);
    }

    private final Map<Class<?>, Object> instanceByType = new ConcurrentHashMap<>();

    ConceptApplication(Config config) {
        ...
        ConceptService conceptService = new ConceptService(config);
        ...
        WebServer server = WebServer.builder(
                Routing.builder()
                        ...
                        .register(health)
                        .register(metrics)
                        .register("/concept", conceptService)
                        .build()
    ...
    public static void main(final String[] args) {
        ConceptApplication app = new ConceptApplication(Config.create());
